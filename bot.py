...
# =========================================================
# OKX SCALPING BOT V13.0 SIX-POINT CONFLUENCE (FIXED)
...
def startup_checks():
    ...
    log(f"SCORE required={max(MIN_SCORE, MAJOR_MIN_SCORE)} | max=6 | ENGINE={VERSION} | SCORE=HTF+LIQUIDITY+BOS+RETEST+FLOW+MOMENTUM | PA=SR+SWEEP+RECLAIM+FRESH_BOS | SR_ATR={SR_ATR_MULT} | SR_PCT={SR_PCT}% | BOS_MAX_AGE={PA_BOS_MAX_AGE_BARS}")
