...
def place_full_position_protection(
    ...
    This specifically prevents the previous
    50024:
        Parameter sz and closeFraction
    ...
    if "sz" in payload:
        ...
        raise RuntimeError(
            ...
            "sz must not exist with closeFraction"
        )
...
def place_order(
    ...
    with order_lock:
        ...
        # -------------------------------------------------
        # MARKET ENTRY ONLY
        # NO ATTACHED TPSL HERE
        #
        # Protection will be created AFTER the position
        # is confirmed. This avoids duplicate protection.
        # -------------------------------------------------
        ...
        # -------------------------------------------------
        # CREATE FULL-POSITION PROTECTION
        # -------------------------------------------------
...
def manage_position_protection(symbol):
    ...
    # -----------------------------------------------------
    # If state was lost after restart, reconstruct
    # initial protection levels.
    # -----------------------------------------------------
    ...
    try:
        ...
        # Try to restore the previous protection
        try:
