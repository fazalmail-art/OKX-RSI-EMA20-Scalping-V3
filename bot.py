...
#                 Default raised from 0.75 -> 1.0 (~33% wider than before)
#                 per explicit request, as a moderate first step rather than
#                 an aggressively loose filter.
...
SR_ATR_MULT = Decimal(os.getenv("SR_ATR_MULT", "1.0"))
