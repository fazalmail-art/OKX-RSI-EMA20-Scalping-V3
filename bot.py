...
def calculate_order_size(symbol, price, atr_pct=None, vol_ratio=None):
    info = get_instrument(symbol)
    ...
    combined_mult = atr_mult * vol_size_mult
...
def place_order(symbol, analysis, snapshot):
    ...
    with order_lock:
        ...
        info = get_instrument(symbol)
        size, actual_notional, vol_mult = calculate_order_size(symbol, ticker_price, atr_pct_for_sizing, analysis.get("volume_ratio"))
