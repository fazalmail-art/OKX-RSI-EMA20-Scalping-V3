...
# ---------------------------------------------------------
# FINAL TRADE SETTINGS
# ---------------------------------------------------------

MARGIN_USDT = Decimal("13")
LEVERAGE = Decimal("5")
...
BREAK_EVEN_TRIGGER_PCT = Decimal("0.30")

BREAK_EVEN_OFFSET_PCT = Decimal("0.15")

TRAIL_START_PCT = Decimal("0.45")

TRAIL_DISTANCE_PCT = Decimal("0.30")
...
def place_full_position_protection(
    ...
    IMPORTANT:
    closeFraction="1" is used for the entire
    position.

    sz is intentionally NOT included because
    OKX does not allow sz together with
    closeFraction for this full-position OCO.
    """
    ...
    with order_lock:
        ...
        if not verified:
            ...
            try:
                ...
                raise RuntimeError(
                    "CRITICAL: PROTECTION NOT VERIFIED "
