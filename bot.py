...
def calculate_order_size(symbol, price, atr_pct=None):
    ...
    # Volatility sizing must never push the margin below the configured
    # MARGIN_USDT floor (default $10) — it can only scale UP on low-volatility
    # symbols, never scale down below the minimum a position is allowed to use.
    effective_margin = max(MARGIN_USDT, MARGIN_USDT * vol_mult)
